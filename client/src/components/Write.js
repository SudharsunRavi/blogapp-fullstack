...
const Write = () => {
  ...
  return (
    <div className=' ml-20 mt-16 flex'>
      <div className='w-3/4'>
        <input type="text" placeholder="Title" className="w-[400px] h-10 text-2xl pl-2 border mb-10" onChange={(e)=>setTitle(e.target.value)}/>
        <div>
      ...
      <div className='w-1/4 mx-20 mb-28 border'>
        ...
        <div className='ml-3'>
          <input type="radio" name="category" value="tech" className='mb-3' onChange={(e)=>setCategory(e.target.value)}/>
          <label htmlFor="tech">Tech</label><br/>

          <input type="radio" name="category" value="science" className='mb-3' onChange={(e)=>setCategory(e.target.value)}/>
          <label htmlFor="science">Science</label><br/>

          <input type="radio" name="category" value="business" className='mb-3'onChange={(e)=>setCategory(e.target.value)}/>
          <label htmlFor="business">Business</label><br/>

          <input type="radio" name="category" value="sports" className='mb-3' onChange={(e)=>setCategory(e.target.value)}/>
          <label htmlFor="sports">Sports</label><br/>

          <input type="radio" name="category" value="culinary" className='mb-3' onChange={(e)=>setCategory(e.target.value)}/>
          <label htmlFor="culinary">Culinary</label><br/>

          <input type="radio" name="category" value="art" className='mb-3' onChange={(e)=>setCategory(e.target.value)}/>
