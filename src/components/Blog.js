    ...
    <div className="mx-[5%] mb-20 flex">
      <div className="w-[75%]">
        ...
        <div className="flex items-center mt-6">
          ...
          />
          <div className="ml-3">
            <span className="font-bold">Sudharsun</span>
            <p>Posted 1 day ago</p>
          </div>

          <div className="flex gap-5 ml-7 mt-5">
            <Link to="/write?edit=2">
              <img src={EDIT_IMG} alt="edit" className="w-[20px]"/>
            </Link>
            <img src={DELETE_IMG} alt="delete" className="w-[20px] cursor-pointer"/>
          </div>
        </div>
        <h1 className="text-4xl font-bold my-10">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h1>
